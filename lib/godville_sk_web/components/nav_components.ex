  ...
  def game_nav(assigns) do
    ...
    <nav class="flex-shrink-0 bg-card border-b border-border flex items-center px-4 h-11 gap-4">
      ...
      <div class="ml-auto flex items-center gap-3 text-xs">
        <span class="text-foreground/50 font-body hidden sm:inline">Realm: <span class="text-primary">Global</span></span>
        <.link href={~p"/users/log_out"} method="delete" class="text-foreground/50 hover:text-primary transition-colors logout-btn" title="Выход">
