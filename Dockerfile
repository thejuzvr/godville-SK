...
#   - Ex: hexpm/elixir:1.14.0-erlang-25.3.2.8-debian-bullseye-20260406-slim
#
...
RUN apt-get update -y && \
  apt-get install -y libstdc++6 openssl libncurses5 locales ca-certificates tini curl \
  && apt-get clean && rm -f /var/lib/apt/lists/*_*
...
COPY --from=builder --chown=app:app /app/_build/${MIX_ENV}/rel/godville_sk ./
