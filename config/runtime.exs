...
#
#     PHX_SERVER=true bin/godville_sk start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :godville_sk, GodvilleSkWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :godville_sk, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :godville_sk, GodvilleSk.Mailer,
